				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="sb-xpme313993052@business.example.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/Linn_ecommerce-master/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/Linn_ecommerce-master/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/Linn_ecommerce-master/cancel.php"/>
